...
export const LgpdConsentModal: React.FC<LgpdConsentModalProps> = ({ patientName, onAccept }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/95 backdrop-blur-xl flex items-start justify-center overflow-y-auto p-4 py-8">
      <div className="w-full max-w-2xl bg-slate-900 rounded-2xl border border-slate-700/60 shadow-2xl overflow-hidden">

        {/* Header */}
        <div className="bg-gradient-to-r from-slate-950 to-[#0F172A] p-6 border-b border-slate-700/40">
          <div className="flex items-start gap-4">
            <div className="p-3 bg-blue-500/15 rounded-2xl border border-blue-500/25 shrink-0">
              <Shield strokeWidth={1.75} className="w-6 h-6 text-blue-400" />
            </div>
            <div>
              ...
              <p className="text-xs text-blue-200/75 mt-2.5 leading-relaxed">
                ...
                <strong className="text-blue-300">Lei n. 13.709/2018 (LGPD)</strong> e a{' '}
                <strong className="text-blue-300">Resolucao CFM n. 1.821/07</strong>.
        ...
        {/* Section Tabs */}
        <div className="flex border-b border-slate-700/40 bg-slate-900/60">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-3 text-xs font-bold transition-colors border-b-2 ${
              activeSection === 'tcle'
                ? 'text-blue-300 border-blue-400 bg-blue-950/30'
                : 'text-blue-500 border-transparent hover:text-blue-400 hover:bg-blue-950/10'
            }`}
          >
            <FileText strokeWidth={1.75} className="w-3.5 h-3.5" />
            TCLE Pediatrico
            {tcleAccepted && <CheckCircle2 strokeWidth={1.75} className="w-3 h-3 text-blue-400" />}
          </button>
          <button
          ...
          >
            <Lock strokeWidth={1.75} className="w-3.5 h-3.5" />
            Politica de Privacidade
            {privacyAccepted && <CheckCircle2 strokeWidth={1.75} className="w-3 h-3 text-blue-400" />}
          </button>
        </div>

        {/* TCLE Content */}
        {activeSection === 'tcle' && (
          <div className="p-5 max-h-64 overflow-y-auto space-y-3.5 text-xs text-blue-100/80 leading-relaxed">
            ...
            <div className="space-y-3">
              <div>
                <p className="font-bold text-blue-300 mb-0.5">1. Controlador de Dados</p>
                <p>
              ...
              <div>
                <p className="font-bold text-blue-300 mb-0.5">2. Dados Coletados e Finalidade</p>
                <p>
              ...
              <div>
                <p className="font-bold text-blue-300 mb-0.5">3. Base Legal</p>
                <p>
              ...
              <div>
                <p className="font-bold text-blue-300 mb-0.5">4. Direitos do Titular</p>
                <p>
              ...
              <div>
                <p className="font-bold text-blue-300 mb-0.5">5. Seguranca e Sigilo</p>
                <p>
              ...
              <div>
                <p className="font-bold text-blue-300 mb-0.5">6. Prazo de Retencao</p>
                <p>
            ...
            {/* Checkbox TCLE */}
            <div className="mt-4 flex items-start gap-2.5 p-3 bg-blue-950/40 border border-blue-800/50 rounded-xl">
              <input
                type="checkbox"
                id="tcle-check"
                checked={tcleAccepted}
                onChange={(e) => setTcleAccepted(e.target.checked)}
                className="mt-0.5 h-4 w-4 rounded border-blue-600 accent-blue-500 cursor-pointer shrink-0"
              />
              <label htmlFor="tcle-check" className="text-xs text-blue-200 font-semibold cursor-pointer leading-relaxed">
            ...
            {!tcleAccepted && (
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 text-xs font-bold text-blue-400 hover:text-blue-300 py-2 transition-colors"
              >
                Aceitar e ir para Politica de Privacidade
                <ChevronRight strokeWidth={1.75} className="w-3.5 h-3.5" />
              </button>
            )}
          </div>
        )}
        ...
        {activeSection === 'privacy' && (
          <div className="p-5 max-h-64 overflow-y-auto space-y-3.5 text-xs text-blue-100/80 leading-relaxed">
            ...
            <div className="space-y-3">
              <div>
                <p className="font-bold text-blue-300 mb-0.5">1. Coleta de Dados</p>
                <p>
              ...
              <div>
                <p className="font-bold text-blue-300 mb-0.5">2. Compartilhamento</p>
                <p>
              ...
              <div>
                <p className="font-bold text-blue-300 mb-0.5">3. Autenticacao e Auditoria</p>
                <p>
              ...
              <div>
                <p className="font-bold text-blue-300 mb-0.5">4. Acesso do Responsavel Legal</p>
                <p>
              ...
              <div>
                <p className="font-bold text-blue-300 mb-0.5">5. Imutabilidade do Prontuario</p>
                <p>
              ...
              <div>
                <p className="font-bold text-blue-300 mb-0.5">6. Alteracoes nesta Politica</p>
                <p>
            ...
            <div className="mt-4 flex items-start gap-2.5 p-3 bg-blue-950/40 border border-blue-800/50 rounded-xl">
              <input
                ...
                className="mt-0.5 h-4 w-4 rounded border-blue-600 accent-blue-500 cursor-pointer shrink-0"
              />
              <label htmlFor="privacy-check" className="text-xs text-blue-200 font-semibold cursor-pointer leading-relaxed">
        ...
        {/* Form Fields & Submit */}
        <div className="p-5 border-t border-slate-700/40 space-y-4 bg-slate-950/40">
          {/* Status indicators */}
            ...
            <div
              className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-[10px] font-bold transition-colors ${
                tcleAccepted
                  ...
                  : 'bg-slate-800 text-blue-500 border border-slate-700'
              }`}
            >
              {tcleAccepted
                ? <CheckCircle2 strokeWidth={1.75} className="w-3.5 h-3.5 text-blue-400 shrink-0" />
                : <AlertCircle strokeWidth={1.75} className="w-3.5 h-3.5 shrink-0" />}
              TCLE Pediatrico
            </div>
            <div
              className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-[10px] font-bold transition-colors ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  autoComplete="name"
                  className="w-full bg-slate-800 border border-slate-600/50 text-white text-xs px-3 py-2.5 rounded-xl placeholder-slate-500/70 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-colors"
                />
              </div>
              <div>
                <label className="block text-xs text-blue-300 font-semibold mb-1">
                ...
                <input
                  ...
                  inputMode="numeric"
                  autoComplete="off"
                  className="w-full bg-slate-800 border border-slate-600/50 text-white text-xs px-3 py-2.5 rounded-xl placeholder-slate-500/70 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-colors font-mono tracking-wide"
                />
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-[#1E3A8A] hover:bg-blue-700 disabled:bg-slate-700 disabled:text-slate-500 text-white text-sm font-extrabold py-3.5 rounded-xl transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/20 shadow-sm disabled:cursor-not-allowed border border-blue-600/30 disabled:border-slate-600/30 disabled:translate-y-0 disabled:shadow-none"
          >
            {submitting
